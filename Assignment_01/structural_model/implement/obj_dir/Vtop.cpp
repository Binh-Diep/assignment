...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , E1_ni{vlSymsp->TOP.E1_ni}
    , E2_ni{vlSymsp->TOP.E2_ni}
    , E3_i{vlSymsp->TOP.E3_i}
    , A0_i{vlSymsp->TOP.A0_i}
    , A1_i{vlSymsp->TOP.A1_i}
    , A2_i{vlSymsp->TOP.A2_i}
    , Q0_no{vlSymsp->TOP.Q0_no}
    , Q1_no{vlSymsp->TOP.Q1_no}
    , Q2_no{vlSymsp->TOP.Q2_no}
    , Q3_no{vlSymsp->TOP.Q3_no}
    , Q4_no{vlSymsp->TOP.Q4_no}
    , Q5_no{vlSymsp->TOP.Q5_no}
    , Q6_no{vlSymsp->TOP.Q6_no}
    , Q7_no{vlSymsp->TOP.Q7_no}
    , rootp{&(vlSymsp->TOP)}
{
