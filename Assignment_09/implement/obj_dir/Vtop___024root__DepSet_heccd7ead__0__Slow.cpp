...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__dut__DOT__A_tmp = VL_RAND_RESET_I(10);
    vlSelf->top__DOT__dut__DOT__Q_tmp = VL_RAND_RESET_I(10);
    vlSelf->top__DOT__dut__DOT__M_tmp = VL_RAND_RESET_I(10);
    vlSelf->top__DOT__dut__DOT__count = VL_RAND_RESET_I(3);
    vlSelf->top__DOT__dut__DOT__REG = VL_RAND_RESET_I(21);
