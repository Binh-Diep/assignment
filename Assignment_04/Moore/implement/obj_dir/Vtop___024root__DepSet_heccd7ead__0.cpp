...
VL_INLINE_OPT void Vtop___024root___sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__dut__DOT__current_state = ((IData)(vlSelf->rst_ni)
                                                  ...
                                                  : 0U);
    vlSelf->valid_o = (4U == (IData)(vlSelf->top__DOT__dut__DOT__current_state));
}
...
VL_INLINE_OPT void Vtop___024root___combo__TOP__0(Vtop___024root* vlSelf) {
    ...
    // Body
    __Vtableidx1 = (((IData)(vlSelf->string_i) << 3U) 
                    | (IData)(vlSelf->top__DOT__dut__DOT__current_state));
    vlSelf->top__DOT__dut__DOT__next_state = Vtop__ConstPool__TABLE_h194e42a4_0
        [__Vtableidx1];
}
